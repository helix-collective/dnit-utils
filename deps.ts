...
import * as hash from "https://deno.land/std@0.97.0/hash/mod.ts";
import * as io from "https://deno.land/std@0.97.0/io/mod.ts";
...
import * as uuid from "https://deno.land/std@0.97.0/uuid/mod.ts";
